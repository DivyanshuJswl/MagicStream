...
func RegisterUser(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "Unable to encrypt password", "details": err.Error()})
			return
		}
...
func LoginUser(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.JSON(http.StatusOK, models.UserResponse{
			...
			Role:      foundUser.Role,
			// Token:          token, // need to pass in http-only cookies instead of sending as response to user
